...
public class CategoriesClient extends BaseClient {
    ...
    @Autowired
    public CategoriesClient(@Value("${explore-with-me-server.url}") String serverUrl, RestTemplateBuilder builder) {
        super(
                builder
    ...
    public ResponseEntity<Object> getCategoriesById(long catId) {
        return get("/" + catId);
    }
}
